...
const { getCinemas, getCinemaById, postCinema, updateCinemaById, deleteCinemaById } = require('../../controllers/cinemas/cinemas.controllers');
...
// post Cinema
cinemasRoutes.post('/cinemas',postCinemasValidator(), validateCinemas,  postCinema);
