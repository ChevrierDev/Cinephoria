document.addEventListener("DOMContentLoaded", () => {
  ...
  if (selectTheater && theaterMenu && selectEmployee && employeeMenu && employeeList && cinemaChosen && cinemaInput && employeeChosen && employeeIdInput && openAlertBtn && alertMenu && closeAlertBtn && submitForm && form) {
      ...
      employeeList.addEventListener("click", (event) => {
          if (event.target.tagName === "LI") {
              ...
              form.setAttribute('action', `/api/v1/users/${selectedEmployeeId}?_method=DELETE`);
